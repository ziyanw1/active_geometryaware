...
--pretrain_restore=True --pretrain_restore_path='/home/ricsonc/MVnet_active/log_agent_all/asdf2/log_agent/pretrain_model.ckpt-1000' --use_segs=False --reproj_mode=True --train_filename_prefix='single' --val_filename_prefix='single' --test_filename_prefix='single'
