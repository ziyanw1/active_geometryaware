...
def test_lmdb(ae):
    ...
    try:
        while not ae.coord.should_stop():
            ...
            rgb_batch = ae.sess.run([ae.rgb_batch], feed_dict=feed_dict)

            print 'Iteration {}, batch_size {}'.format(i, np.asarray(rgb_batch).shape)
...
if __name__ == "__main__":
    ...
    #DL = data_loader(FLAGS)
    #print 'length: {}'.format(DL.ds_train.size())
    #for i in range(15):
    #    a = next(DL.ds_train.get_data())
    #    print 'Iter {}'.format(i)
    #    if i == 14:
    #        print a[4] 
    ...
    #for i in range(1000):
    #    data_ = DL.next_(True)
    #    print 'Iter: {}, size {}'.format(i, len(data_))
    #    if data_ is None:
    #        break
    #    print data_[2]
