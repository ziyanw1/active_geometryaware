...
class lmdb_writer(DataFlow):
    ...
    def get_data(self):
        for i, model_id in enumerate(self.model_ids):
            ...
            yield [vox_model_zoom.astype(np.uint8)]
...
if __name__ == "__main__":
    ...
    for category_name in categories:
        ...
        for splits in splits_list:        
            ...
            lmdb_write = os.path.join(write_path, 'voxel_single_{}_0313_{}.tfr'.format(category_name, lmdb_name_append)) 
            size_write = os.path.join(write_path, 'voxel_single_{}_0313_{}.npy'.format(category_name, lmdb_name_append))
